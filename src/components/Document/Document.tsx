  ...
  const documentPosts: DocumentPost[] = [
    {
      ...
      excerpt:
        "Rối loạn tăng động giảm chú ý(Attention-Deficit/Hyperactivity Disorder) là một trong những rối loạn phát triển tâm thần kinh ở trẻ em.",
    ...
    },
    {
      ...
      excerpt:
        "Sức khỏe tâm lý của học sinh có thể bị ảnh hưởng bởi nhiều yếu tố như áp lực học tập, môi trường gia đình và bạn bè. Nhận biết sớm những dấu hiệu này giúp giáo viên và phụ huynh có biện pháp hỗ trợ kịp thời...",
    ...
    },
    {
      ...
      excerpt:
        "Tâm lý học học đường đóng vai trò quan trọng trong việc hỗ trợ sự phát triển tâm lý, cảm xúc và xã hội của học sinh. Các chuyên gia tâm lý học đường giúp phát hiện sớm các vấn đề tâm lý, hỗ trợ học sinh vượt qua áp lực học tập và phát triển kĩ năng sống.",
      author: "ThS. Lê Văn C",
      date: "10/03/2024",
      imageUrl: doc3,
    ...
    },
    {
      ...
      excerpt:
        "Bộ tài liệu đầy đủ về các hoạt động và bài tập phát triển kỹ năng sống thiết yếu cho học sinh. Phương pháp giảng dạy và đánh giá...",
